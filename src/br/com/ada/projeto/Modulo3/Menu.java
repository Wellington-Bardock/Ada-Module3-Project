...
public class Menu {
    public static final String ID_PRODUTO = "Por favor, qual será o ID desse produto:";
    ...
    public static final String ID_PRODUTO_VENDA = "Por favor, informar o ID do produto que será vendido:";
    ...
    public static final String MENU_INICIAL = """
            ...
            1 - Cadastrar Produto
            2 - Realizar venda
            3 - Editar Estoque(Opção Indisponível)
            """;
    ...
    public static void main(String[] args) {
        ...
        if (menu.equals(TipoOperacoes.CADASTRO_PRODUTO)) {
            ...
            aplicacao.inserirProdutoEstoque(NOME_DO_PRODUTO, QUANTIDADE_EM_ESTOQUE, VALOR_DO_PRODUTO, ID_PRODUTO, NOVO_PRODUTO);
